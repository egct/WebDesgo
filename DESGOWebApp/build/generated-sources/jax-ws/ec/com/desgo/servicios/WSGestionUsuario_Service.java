 ...
 * 
 */
@WebServiceClient(name = "WSGestionUsuario", targetNamespace = "http://servicios.desgo.com.ec/", wsdlLocation = "http://amazondesgowebservice-env-2.us-east-1.elasticbeanstalk.com:80/WSGestionUsuario?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://amazondesgowebservice-env-2.us-east-1.elasticbeanstalk.com:80/WSGestionUsuario?wsdl");
